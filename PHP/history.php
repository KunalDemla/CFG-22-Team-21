...
<div class="container">
      <a href="addrecord.php">Add Patient Record</a>
        </div>
            ...
            <div class="table-responsive">
                <table>
                    ...
                    include 'conn.php';
                        ...
                        $selectQuery= "select* from p_history";
                      ...
                      <tr>
                            ...
                            <td><a href="delete.php?id=<?php echo $res['u_id'] ?>" data-toggle="tooltip" data-placement="top"  title="Delete">
